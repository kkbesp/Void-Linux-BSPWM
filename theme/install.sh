...
THEME_NAME=ctlos-qogir
THEME_VARIANTS=('' '-manjaro' '-ubuntu')
WIN_VARIANTS=('' '-win')
COLOR_VARIANTS=('' '-light' '-dark')
LOGO_VARIANTS=('' '-arch' '-ctlos' '-budgie' '-debian' '-fedora' '-gnome' '-manjaro' '-ubuntu')
LOGO_NAME=''
...
usage() {
  ...
  printf "  %-25s%s\n" "-l, --logo VARIANTS" "Specify nautilus logo [arch|ctlos|budgie|debian|fedora|gnome|manjaro|ubuntu] (Default: qogir icon)"
